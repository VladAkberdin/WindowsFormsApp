...
namespace WindowsFormsApp {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(string Фамилия, string Имя, string Отчество, string Адрес, System.DateTime Дата_рождения) {
...
namespace WindowsFormsApp.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Фамилия], [Имя], [Отчество], [Адрес], [Дата рождения]" +
                ") VALUES (@Фамилия, @Имя, @Отчество, @Адрес, @Дата_рождения);\r\nSELECT Id, Фамили" +
                "я, Имя, Отчество, Адрес, [Дата рождения] FROM [Table] WHERE (Id = SCOPE_IDENTITY" +
                "())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Фамилия] = @Фамилия, [Имя] = @Имя, [Отчество] = @Отчество, [Адрес] = @Адрес, [Дата рождения] = @Дата_рождения WHERE (([Id] = @Original_Id) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)) AND ((@IsNull_Адрес = 1 AND [Адрес] IS NULL) OR ([Адрес] = @Original_Адрес)) AND ((@IsNull_Дата_рождения = 1 AND [Дата рождения] IS NULL) OR ([Дата рождения] = @Original_Дата_рождения)));
SELECT Id, Фамилия, Имя, Отчество, Адрес, [Дата рождения] FROM [Table] WHERE (Id = @Id)";
        ...
        public virtual int Delete(int Original_Id, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Адрес, global::System.Nullable<global::System.DateTime> Original_Дата_рождения) {
        ...
        public virtual int Update(string Фамилия, string Имя, string Отчество, string Адрес, global::System.Nullable<global::System.DateTime> Дата_рождения, int Original_Id, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Адрес, global::System.Nullable<global::System.DateTime> Original_Дата_рождения, int Id) {
            if ((Фамилия == null)) {
        ...
        public virtual int Update(string Фамилия, string Имя, string Отчество, string Адрес, global::System.Nullable<global::System.DateTime> Дата_рождения, int Original_Id, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Адрес, global::System.Nullable<global::System.DateTime> Original_Дата_рождения) {
            return this.Update(Фамилия, Имя, Отчество, Адрес, Дата_рождения, Original_Id, Original_Фамилия, Original_Имя, Original_Отчество, Original_Адрес, Original_Дата_рождения, Original_Id);
        }
    }
